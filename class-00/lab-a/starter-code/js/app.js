...
function displayPics(){
  ...
  // because it is out of scope for 'rando', as we can see 'rando' declared inside code block(loop), then it called outside that block. and as we know 'let' declaration is block scope.  console.log(viewed);
